...
import (
	...
	v1 "github.com/jenkins-x/jx-api/v4/pkg/client/listers/jenkins.io/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.JenkinsV1().SourceRepositories(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JenkinsV1().SourceRepositories(namespace).Watch(context.TODO(), options)
			},
		},
