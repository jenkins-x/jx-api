...
type GitServiceInformer interface {
	...
	Lister() v4beta1.GitServiceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JenkinsV4beta1().GitServices(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JenkinsV4beta1().GitServices(namespace).Watch(context.TODO(), options)
			},
		},
		&jenkinsiov4beta1.GitService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gitServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jenkinsiov4beta1.GitService{}, f.defaultInformer)
}

func (f *gitServiceInformer) Lister() v4beta1.GitServiceLister {
	return v4beta1.NewGitServiceLister(f.Informer().GetIndexer())
}
