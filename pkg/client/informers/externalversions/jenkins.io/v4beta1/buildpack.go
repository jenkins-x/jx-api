...
type BuildPackInformer interface {
	...
	Lister() v4beta1.BuildPackLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JenkinsV4beta1().BuildPacks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JenkinsV4beta1().BuildPacks(namespace).Watch(context.TODO(), options)
			},
		},
		&jenkinsiov4beta1.BuildPack{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *buildPackInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jenkinsiov4beta1.BuildPack{}, f.defaultInformer)
}

func (f *buildPackInformer) Lister() v4beta1.BuildPackLister {
	return v4beta1.NewBuildPackLister(f.Informer().GetIndexer())
}
