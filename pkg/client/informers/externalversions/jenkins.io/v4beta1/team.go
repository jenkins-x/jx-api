	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JenkinsV4beta1().Teams(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JenkinsV4beta1().Teams(namespace).Watch(context.TODO(), options)
			},
		},
		&jenkinsiov4beta1.Team{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *teamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jenkinsiov4beta1.Team{}, f.defaultInformer)
}

func (f *teamInformer) Lister() v4beta1.TeamLister {
	return v4beta1.NewTeamLister(f.Informer().GetIndexer())
}
