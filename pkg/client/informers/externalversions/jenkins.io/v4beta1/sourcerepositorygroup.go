...
type SourceRepositoryGroupInformer interface {
	...
	Lister() v4beta1.SourceRepositoryGroupLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JenkinsV4beta1().SourceRepositoryGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JenkinsV4beta1().SourceRepositoryGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&jenkinsiov4beta1.SourceRepositoryGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sourceRepositoryGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jenkinsiov4beta1.SourceRepositoryGroup{}, f.defaultInformer)
}

func (f *sourceRepositoryGroupInformer) Lister() v4beta1.SourceRepositoryGroupLister {
	return v4beta1.NewSourceRepositoryGroupLister(f.Informer().GetIndexer())
}
