...
type CommitStatusInformer interface {
	...
	Lister() v4beta1.CommitStatusLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JenkinsV4beta1().CommitStatuses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JenkinsV4beta1().CommitStatuses(namespace).Watch(context.TODO(), options)
			},
		},
		&jenkinsiov4beta1.CommitStatus{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *commitStatusInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jenkinsiov4beta1.CommitStatus{}, f.defaultInformer)
}

func (f *commitStatusInformer) Lister() v4beta1.CommitStatusLister {
	return v4beta1.NewCommitStatusLister(f.Informer().GetIndexer())
}
