	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JenkinsV4beta1().Apps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JenkinsV4beta1().Apps(namespace).Watch(context.TODO(), options)
			},
		},
		&jenkinsiov4beta1.App{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *appInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jenkinsiov4beta1.App{}, f.defaultInformer)
}

func (f *appInformer) Lister() v4beta1.AppLister {
	return v4beta1.NewAppLister(f.Informer().GetIndexer())
}
