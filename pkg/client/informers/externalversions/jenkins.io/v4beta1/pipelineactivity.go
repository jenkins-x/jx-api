...
type PipelineActivityInformer interface {
	...
	Lister() v4beta1.PipelineActivityLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JenkinsV4beta1().PipelineActivities(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JenkinsV4beta1().PipelineActivities(namespace).Watch(context.TODO(), options)
			},
		},
		&jenkinsiov4beta1.PipelineActivity{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineActivityInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jenkinsiov4beta1.PipelineActivity{}, f.defaultInformer)
}

func (f *pipelineActivityInformer) Lister() v4beta1.PipelineActivityLister {
	return v4beta1.NewPipelineActivityLister(f.Informer().GetIndexer())
}
