	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JenkinsV4beta1().Releases(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JenkinsV4beta1().Releases(namespace).Watch(context.TODO(), options)
			},
		},
		&jenkinsiov4beta1.Release{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *releaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jenkinsiov4beta1.Release{}, f.defaultInformer)
}

func (f *releaseInformer) Lister() v4beta1.ReleaseLister {
	return v4beta1.NewReleaseLister(f.Informer().GetIndexer())
}
