...
type SourceRepositoryInformer interface {
	...
	Lister() v4beta1.SourceRepositoryLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JenkinsV4beta1().SourceRepositories(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JenkinsV4beta1().SourceRepositories(namespace).Watch(context.TODO(), options)
			},
		},
		&jenkinsiov4beta1.SourceRepository{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sourceRepositoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jenkinsiov4beta1.SourceRepository{}, f.defaultInformer)
}

func (f *sourceRepositoryInformer) Lister() v4beta1.SourceRepositoryLister {
	return v4beta1.NewSourceRepositoryLister(f.Informer().GetIndexer())
}
