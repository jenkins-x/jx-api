...
type ExtensionInformer interface {
	...
	Lister() v4beta1.ExtensionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JenkinsV4beta1().Extensions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JenkinsV4beta1().Extensions(namespace).Watch(context.TODO(), options)
			},
		},
		&jenkinsiov4beta1.Extension{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *extensionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jenkinsiov4beta1.Extension{}, f.defaultInformer)
}

func (f *extensionInformer) Lister() v4beta1.ExtensionLister {
	return v4beta1.NewExtensionLister(f.Informer().GetIndexer())
}
