...
type ReleaseLister interface {
	...
	List(selector labels.Selector) (ret []*v4beta1.Release, err error)
...
// List lists all Releases in the indexer.
func (s *releaseLister) List(selector labels.Selector) (ret []*v4beta1.Release, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v4beta1.Release))
	})
	return ret, err
}
...
type ReleaseNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v4beta1.Release, error)
...
// List lists all Releases in the indexer for a given namespace.
func (s releaseNamespaceLister) List(selector labels.Selector) (ret []*v4beta1.Release, err error) {
...
// Get retrieves the Release from the indexer for a given namespace and name.
func (s releaseNamespaceLister) Get(name string) (*v4beta1.Release, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v4beta1.Resource("release"), name)
	}
	return obj.(*v4beta1.Release), nil
}
