...
func (c *releases) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Release, err error) {
	result = &v1.Release{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ReleaseList, err error) {
...
func (c *releases) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *releases) Create(ctx context.Context, release *v1.Release, opts metav1.CreateOptions) (result *v1.Release, err error) {
	result = &v1.Release{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) Update(ctx context.Context, release *v1.Release, opts metav1.UpdateOptions) (result *v1.Release, err error) {
	result = &v1.Release{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *releases) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *releases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Release, err error) {
	result = &v1.Release{}
