...
func (c *buildPacks) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.BuildPack, err error) {
	result = &v1.BuildPack{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("buildpacks").
...
func (c *buildPacks) List(ctx context.Context, opts metav1.ListOptions) (result *v1.BuildPackList, err error) {
...
func (c *buildPacks) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *buildPacks) Create(ctx context.Context, buildPack *v1.BuildPack, opts metav1.CreateOptions) (result *v1.BuildPack, err error) {
	result = &v1.BuildPack{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("buildpacks").
...
func (c *buildPacks) Update(ctx context.Context, buildPack *v1.BuildPack, opts metav1.UpdateOptions) (result *v1.BuildPack, err error) {
	result = &v1.BuildPack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("buildpacks").
...
func (c *buildPacks) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *buildPacks) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *buildPacks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.BuildPack, err error) {
	result = &v1.BuildPack{}
