...
func (c *FakeSourceRepositoryGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *jenkinsiov1.SourceRepositoryGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeSourceRepositoryGroups) List(ctx context.Context, opts v1.ListOptions) (result *jenkinsiov1.SourceRepositoryGroupList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSourceRepositoryGroups) Create(ctx context.Context, sourceRepositoryGroup *jenkinsiov1.SourceRepositoryGroup, opts v1.CreateOptions) (result *jenkinsiov1.SourceRepositoryGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeSourceRepositoryGroups) Update(ctx context.Context, sourceRepositoryGroup *jenkinsiov1.SourceRepositoryGroup, opts v1.UpdateOptions) (result *jenkinsiov1.SourceRepositoryGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeSourceRepositoryGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *jenkinsiov1.SourceRepositoryGroup, err error) {
	obj, err := c.Fake.
