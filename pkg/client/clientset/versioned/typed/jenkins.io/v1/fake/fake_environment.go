...
func (c *FakeEnvironments) Get(ctx context.Context, name string, options v1.GetOptions) (result *jenkinsiov1.Environment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(environmentsResource, c.ns, name), &jenkinsiov1.Environment{})

	if obj == nil {
		return nil, err
	}
	return obj.(*jenkinsiov1.Environment), err
}

// List takes label and field selectors, and returns the list of Environments that match those selectors.
func (c *FakeEnvironments) List(ctx context.Context, opts v1.ListOptions) (result *jenkinsiov1.EnvironmentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(environmentsResource, environmentsKind, c.ns, opts), &jenkinsiov1.EnvironmentList{})
	...
	list := &jenkinsiov1.EnvironmentList{ListMeta: obj.(*jenkinsiov1.EnvironmentList).ListMeta}
	for _, item := range obj.(*jenkinsiov1.EnvironmentList).Items {
...
func (c *FakeEnvironments) Create(ctx context.Context, environment *jenkinsiov1.Environment, opts v1.CreateOptions) (result *jenkinsiov1.Environment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(environmentsResource, c.ns, environment), &jenkinsiov1.Environment{})
...
func (c *FakeEnvironments) Update(ctx context.Context, environment *jenkinsiov1.Environment, opts v1.UpdateOptions) (result *jenkinsiov1.Environment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(environmentsResource, c.ns, environment), &jenkinsiov1.Environment{})
...
func (c *FakeEnvironments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(environmentsResource, c.ns, name), &jenkinsiov1.Environment{})
...
func (c *FakeEnvironments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &jenkinsiov1.EnvironmentList{})
	return err
}

// Patch applies the patch and returns the patched environment.
func (c *FakeEnvironments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *jenkinsiov1.Environment, err error) {
	obj, err := c.Fake.
