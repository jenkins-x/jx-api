...
func (c *FakeCommitStatuses) Get(ctx context.Context, name string, options v1.GetOptions) (result *jenkinsiov1.CommitStatus, err error) {
	obj, err := c.Fake.
...
func (c *FakeCommitStatuses) List(ctx context.Context, opts v1.ListOptions) (result *jenkinsiov1.CommitStatusList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCommitStatuses) Create(ctx context.Context, commitStatus *jenkinsiov1.CommitStatus, opts v1.CreateOptions) (result *jenkinsiov1.CommitStatus, err error) {
	obj, err := c.Fake.
...
func (c *FakeCommitStatuses) Update(ctx context.Context, commitStatus *jenkinsiov1.CommitStatus, opts v1.UpdateOptions) (result *jenkinsiov1.CommitStatus, err error) {
	obj, err := c.Fake.
...
func (c *FakeCommitStatuses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *jenkinsiov1.CommitStatus, err error) {
	obj, err := c.Fake.
