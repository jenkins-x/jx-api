...
import (
	...
	"github.com/jenkins-x/jx-api/v4/pkg/apis/jenkins.io/v4beta1"
...
func Test_OverrideRequirementsFromEnvironment_populate_requirements_from_environment_variables(t *testing.T) {
	var overrideTests = []struct {
		...
		{v4beta1.RequirementKaniko, "true", v4beta1.RequirementsConfig{Kaniko: true}},
		{v4beta1.RequirementKaniko, "false", v4beta1.RequirementsConfig{Kaniko: false}},
		{v4beta1.RequirementKaniko, "", v4beta1.RequirementsConfig{Kaniko: false}},
		...
		// VeleroConfig
		{v4beta1.RequirementVeleroServiceAccountName, "my-velero-sa", v4beta1.RequirementsConfig{Velero: v4beta1.VeleroConfig{ServiceAccount: "my-velero-sa"}}},
		{v4beta1.RequirementVeleroTTL, "60", v4beta1.RequirementsConfig{Velero: v4beta1.VeleroConfig{TimeToLive: "60"}}},
		{v4beta1.RequirementVeleroSchedule, "0 * * * *", v4beta1.RequirementsConfig{Velero: v4beta1.VeleroConfig{Schedule: "0 * * * *"}}},

		// Storage
		{v4beta1.RequirementStorageBackupEnabled, "true", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Backup: v4beta1.StorageEntryConfig{Enabled: true}}}},
		{v4beta1.RequirementStorageBackupEnabled, "false", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Backup: v4beta1.StorageEntryConfig{Enabled: false}}}},
		{v4beta1.RequirementStorageBackupEnabled, "", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Backup: v4beta1.StorageEntryConfig{Enabled: false}}}},
		{v4beta1.RequirementStorageBackupURL, "gs://my-backup", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Backup: v4beta1.StorageEntryConfig{URL: "gs://my-backup"}}}},

		{v4beta1.RequirementStorageLogsEnabled, "true", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Logs: v4beta1.StorageEntryConfig{Enabled: true}}}},
		{v4beta1.RequirementStorageLogsEnabled, "false", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Logs: v4beta1.StorageEntryConfig{Enabled: false}}}},
		{v4beta1.RequirementStorageLogsEnabled, "", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Logs: v4beta1.StorageEntryConfig{Enabled: false}}}},
		{v4beta1.RequirementStorageLogsURL, "gs://my-logs", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Logs: v4beta1.StorageEntryConfig{URL: "gs://my-logs"}}}},

		{v4beta1.RequirementStorageReportsEnabled, "true", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Reports: v4beta1.StorageEntryConfig{Enabled: true}}}},
		{v4beta1.RequirementStorageReportsEnabled, "false", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Reports: v4beta1.StorageEntryConfig{Enabled: false}}}},
		{v4beta1.RequirementStorageReportsEnabled, "", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Reports: v4beta1.StorageEntryConfig{Enabled: false}}}},
		{v4beta1.RequirementStorageReportsURL, "gs://my-reports", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Reports: v4beta1.StorageEntryConfig{URL: "gs://my-reports"}}}},

		{v4beta1.RequirementStorageRepositoryEnabled, "true", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Repository: v4beta1.StorageEntryConfig{Enabled: true}}}},
		{v4beta1.RequirementStorageRepositoryEnabled, "false", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Repository: v4beta1.StorageEntryConfig{Enabled: false}}}},
		{v4beta1.RequirementStorageRepositoryEnabled, "", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Repository: v4beta1.StorageEntryConfig{Enabled: false}}}},
		{v4beta1.RequirementStorageRepositoryURL, "gs://my-repo", v4beta1.RequirementsConfig{Storage: v4beta1.StorageConfig{Repository: v4beta1.StorageEntryConfig{URL: "gs://my-repo"}}}},
		...
		},
		{
			...
			Original: &v4beta1.RequirementsConfig{
				Storage: v4beta1.StorageConfig{
					Logs: v4beta1.StorageEntryConfig{
						Enabled: true,
						URL:     "value1",
					},
					Reports: v4beta1.StorageEntryConfig{},
					Repository: v4beta1.StorageEntryConfig{
						Enabled: true,
						URL:     "value3",
					},
				},
